...
| [capability-resolution.md](capability-resolution.md) | Provider-neutral contracts, optional Nacos adapters, cache/reliability, and replay. |
| [nacos-live-architecture.md](nacos-live-architecture.md) | Current .NET Nacos live acceptance flow, optional Gateway composition, managed/NativeAOT smoke, and evidence contract. |
